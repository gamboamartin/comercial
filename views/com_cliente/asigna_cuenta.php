...
<main class="main section-color-primary">
    <div class="container">
        ...
        <div class="col-md-12 buttons-form">
            <?php echo $controlador->button_com_cliente_cuenta; ?>
        </div>
    </div>
            ...
            <div class="col-md-12">
                <div class="widget widget-box box-container widget-mylistings">
                    <table class="table table-striped">
                        ...
                        <tbody>
                        <?php
                        foreach ($controlador->registros['cuentas_cliente'] as $cuenta_cliente){
                        ?>
                        <tr>
                            <td><?php echo $cuenta_cliente['com_cliente_cuenta_id'] ?></td>
                            <td><?php echo $cuenta_cliente['bn_banco_descripcion'] ?></td>
                            <td><?php echo $cuenta_cliente['com_cliente_cuenta_num_cuenta'] ?></td>
                            <td><?php echo $cuenta_cliente['com_cliente_cuenta_clabe'] ?></td>
                            <td><?php echo $cuenta_cliente['elimina_bd'] ?></td>
                        </tr>
                        <?php } ?>
                        </tbody>
                    </table>
