...
class controlador_com_contacto extends _base_sin_cod {
    ...
    public function __construct(PDO $link, html $html = new \gamboamartin\template_1\html(),
        ...
        $html_ = new com_contacto_html(html: $html);
    ...
    public function alta(bool $header, bool $ws = false): array|string
    {
        ...
        $com_cliente_id = (new com_contacto_html(html: $this->html_base))->select_com_cliente_id(
        ...
        $descripcion = (new com_contacto_html(html: $this->html_base))->input_contacto(cols: 12,row_upd:  new stdClass(),
    ...
    public function init_datatable(): stdClass
    {
        ...
        $datatables->columns['com_contacto_descripcion']['titulo'] = 'Contacto';

        $datatables->filtro = array();
        $datatables->filtro[] = 'com_contacto.id';
        $datatables->filtro[] = 'com_contacto.descripcion';
    ...
    public function modifica(bool $header, bool $ws = false, array $keys_selects = array()): array|stdClass
    {
        ...
        $descripcion = (new com_contacto_html(html: $this->html_base))->input_contacto(cols: 12,row_upd:  $this->row_upd,
            value_vacio:  false, name: 'descripcion');
